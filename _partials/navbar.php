<nav class="navbar navbar-expand-lg bg-light" style="width:100%; height: 130px; padding:0;">
    <div class="container-fluid" style="background-color: #0078d7; width:100%; height:100%; display:flex; justify-content: space-between;">
        <div class="navbar-brand" style=" display: flex; flex-direction: row; justify-content: center; align-items: center;">
            ...
            <input class="form-control me-2" style="margin-left:20px" type="search" placeholder="Chercher un parking" aria-label="Search">
        </div>
        <div id="navbarSupportedContent">
        <ul class="navbar-nav me-auto mb-2 mb-lg-0" style="gap:10px">
        <li class="nav-item">
                <a href="index.php?component=home" class=" btn btn-outline-secondary btn-nav" style="color:yellow; border-color:yellow">Tableau de bord</a>
            </li>
            <li class="nav-item">
            ...
            <li class="nav-item">
                <button type="button" class=" btn btn-outline-secondary btn-nav" style="color:yellow; border-color:yellow">Mes reservations</button>
            </li>
            <li class="nav-item">
